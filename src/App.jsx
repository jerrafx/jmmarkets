  ...
  return ( 
    <div className={`p-3 sm:p-4 ${themeColors.subtleBg} shadow-md flex justify-between items-center sticky top-0 z-40`}> 
      ...
      <div className="flex items-center space-x-1 sm:space-x-2"> 
        {showHomeButton && onNavigateToHome && title !== "JMarkets.nl" && ( // Verberg Home knop als titel al JMarkets.nl is (om dubbel te voorkomen)
...
const DashboardNavbar = ({ onToggleTheme, currentTheme, themeColors, onNavigateToTimeline, onNavigateToContact, isAdmin, onAdminLogout, onTabChange, activeTab, onNavigateToLanding }) => { 
    ...
    if (isAdmin) { baseNavLinks.push({ name: 'Admin', icon: ShieldCheck, action: () => onTabChange('admin') }); } 
    return ( 
        ...
        try {
            ...
            if (userDocSnap.exists()) {
                ...
                await setDoc(userDocRef, { 
                    email: firebaseUser.email || 'anoniem', 
                    name: firebaseUser.displayName || 'Admin JMarkets', 
